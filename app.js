...
var questions = [
    {
        question: "Which of the following statement is/are correct about asteroid '1998 OR2'?",
        answer: "All the above are correct",
        options: [
            "It has a diameter of 1.8-4.1 km.",
            " It was found in 1998.",
            "It will stay 3.9 million miles away from our planet.",
            "All the above are correct"
        ]
    },
    {
        question: "When the first asteroid named Ceres was discovered?",
    ...
    {
        question: "Which law suggested that there should be a planet between Mars and Jupiter?",
        answer: " Bode's Law",
        options: [
            " Bode's Law",
            " Planetary Law",
    ...
    {
        question: "Asteroids are made up of",
...
function loginButton() {
    ...
    if (username.value === "Richa" && password.value === "1329") {
